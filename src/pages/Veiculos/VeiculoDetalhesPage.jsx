            ...
            veiculo.disponivel === 1 ? (
              <Link to={`/reservar/${id}`} className="flex-1">
                <Button fullWidth variant="amber" size="lg">
                  <Calendar size={17} /> Reservar Este Veículo
                </Button>
              </Link>
            ) : (
              <div className="flex-1 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-center text-red-400 text-sm font-medium">
