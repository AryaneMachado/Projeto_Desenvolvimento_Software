...
const INICIAL = {
  ...
  portas: 4, passageiros: 5, km: 0, valor_diaria: '', disponivel: 1,
};
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-gray-900/50 border border-white/5 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {isEdit && (
                  <Select id="disponivel" label="Disponibilidade" value={form.disponivel} onChange={(e) => set('disponivel', Number(e.target.value))}>
